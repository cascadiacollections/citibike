...
Citibike.prototype.get = function(url, params, callback) {
	...
	req.on('error', this.handleResponseError);
 ...
 * TODO: Document
 */
Citibike.prototype.handleRequest = function () {
 ...
 * TODO: Document
 */
Citibike.prototype.handleData = function () {
 ...
 */
Citibike.prototype.handleResponseError = function (err) {
